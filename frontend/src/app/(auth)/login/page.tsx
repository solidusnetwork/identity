...
export default function LoginPage() {
  ...
  // Render QR Grid (Mock — 16x16 deterministic pseudorandom grid)
  const renderMockQR = () => {
    const size = 16
    const blocks = []
        ...
        <div className="w-full bg-[#1A1A2E] rounded-[12px] p-[28px] shadow-[0_2px_8px_rgba(0,0,0,0.32)] border border-[#242438]">
          ...
          <div className="relative opacity-50 pointer-events-none">
            <div className="absolute -top-2.5 right-3 z-10">
              <span className="bg-[#0066FF]/20 text-[#0066FF] text-[10px] font-semibold px-2 py-0.5 rounded-full uppercase tracking-wider">Coming Soon</span>
            </div>
            <button
              className="w-full h-[48px] bg-[#242438] border border-[#2A2A42] rounded-[6px] flex items-center justify-center cursor-not-allowed"
              disabled
            >
              ...
              <span className="font-normal text-[14px] text-white">Sign in with Solidus Extension</span>
          ...
          <div className="flex flex-col items-center w-full relative opacity-50 pointer-events-none">
            ...
            <div className="relative flex flex-col items-center">
              <div className="relative w-[230px] h-[230px] flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full -rotate-90">
                  <circle cx="115" cy="115" r={qrRadius} fill="none" stroke="#2A2A42" strokeWidth="1" />
                  <circle
